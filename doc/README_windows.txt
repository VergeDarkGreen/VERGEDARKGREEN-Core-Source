...
Intro
-----
XVGDG (XVGDG) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. XVGDG utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run XVGDG-qt.exe.

XVGDG Core is the original XVGDG client and it builds the backbone of the network.
However, it downloads and stores the entire history of XVGDG transactions;
