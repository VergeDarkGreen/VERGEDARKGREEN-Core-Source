...
In order to support loading of multiple wallets in XVGDG-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is XVGDG.cpp.
...
Changes to XVGDG.cpp
----------------------
XVGDG.cpp is the entry point into XVGDG-qt, and as such, will require some minor modifications to provide hooks for
...
The string parameter is just an XVGDGtrary name given to the default wallet. It's been prepended with a tilde to avoid name collisions in the future with additional wallets.
