...
This mechanism has been integrated into Bitcore-Node-XVGDG which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/XVGDG/insight-api-XVGDG#web-socket-api](https://github.com/XVGDG/insight-api-XVGDG#web-socket-api)
* API: [https://github.com/XVGDG/insight-api-XVGDG#swifttx-transactions](https://github.com/XVGDG/insight-api-XVGDG#swifttx-transactions)
...
By default, the XVGDG Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the XVGDG Core daemon:
