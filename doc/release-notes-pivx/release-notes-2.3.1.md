XVGDG Core version 2.3.1 is now available from:
...
XVGDG Core is extensively tested on multiple operating systems using
...
XVGDG Core should also work on most other Unix-like systems but is not
...
Examples:
> XVGDG-cli startmasternode "alias" true "my_mn"
...
Examples:
> XVGDG-cli mnbudgetvote "local" "ed2f83cedee59a91406f5f47ec4d60bf5a7f9ee6293913c82976bd2d3a658041" "yes"
...
[
  {
    ...
    "PaymentAddress": "xxxx",     (string) XVGDG address of payment
