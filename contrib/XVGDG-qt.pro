...
RESOURCES += src/qt/XVGDG.qrc src/qt/XVGDG_locale.qrc

TRANSLATIONS += src/qt/locale/XVGDG_bg.ts \
                src/qt/locale/XVGDG_de.ts \
                src/qt/locale/XVGDG_en.ts \
                src/qt/locale/XVGDG_es.ts \
                src/qt/locale/XVGDG_fi.ts \
                src/qt/locale/XVGDG_fr.ts \
                src/qt/locale/XVGDG_it.ts \
                src/qt/locale/XVGDG_ja.ts \
                src/qt/locale/XVGDG_pl.ts \
                src/qt/locale/XVGDG_pt.ts \
                src/qt/locale/XVGDG_ru.ts \
                src/qt/locale/XVGDG_sk.ts \
                src/qt/locale/XVGDG_sv.ts \
                src/qt/locale/XVGDG_vi.ts \
                src/qt/locale/XVGDG_zh_CN.ts \
                src/qt/locale/XVGDG_zh_TW.ts
