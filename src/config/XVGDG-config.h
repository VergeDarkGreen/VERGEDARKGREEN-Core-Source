/* src/config/XVGDG-config.h.  Generated from XVGDG-config.h.in by configure.  */
/* src/config/XVGDG-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef XVGDG_CONFIG_H

#define XVGDG_CONFIG_H
...
#define PACKAGE_NAME "XVGDG Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "XVGDG Core 2.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "XVGDG"
