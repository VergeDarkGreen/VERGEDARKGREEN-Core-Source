...
/** Utility functions used by the XVGDG Qt UI.
 */
namespace GUIUtil
{
...
// Render XVGDG addresses in monospace font
...
// Parse "XVGDG:" URI into recipient object, return true on successful parsing
