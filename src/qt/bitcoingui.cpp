                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("XVGDG Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a XVGDG address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and XVGDG: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About XVGDG Core"), this);
    aboutAction->setStatusTip(tr("Show information about XVGDG Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for XVGDG"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your XVGDG addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified XVGDG addresses"));
    ...
    openAction->setStatusTip(tr("Open a XVGDG: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the XVGDG Core help message to get a list with possible XVGDG command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("XVGDG Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XVGDG network", "", count));
}
...
{
    QString strTitle = tr("XVGDG Core"); // default title
