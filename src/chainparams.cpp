...
// VergeDarkGreen
// Copyright (c) 2019 The XVGDG developers
...
// 00000000003134bd8442f387cff31aaa14156b7fe797fb6fb6f690dce4ff6365
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
    (0, uint256("0x00000deaea5a66375720745e389035ed4b2ac57529e7f34b91e4eb46f13f69a2"))
    (14494, uint256("00000000003134bd8442f387cff31aaa14156b7fe797fb6fb6f690dce4ff6365"))
	;

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1553325590, // * UNIX timestamp of last checkpoint block
    15949,          // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // XVGDG: 1 day
        nTargetSpacing = 1 * 60;  // XVGDG: 1 minute
        nMaturity = 19;
        ...
        nLastPOWBlock = 30000;
        nModifierUpdateBlock = 1; // we use the version 1 for XVGDG

        const char* pszTimestamp = "We love green and miners 2019";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1552149237;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2417115;
		...
		assert(hashGenesisBlock == uint256("0x00000deaea5a66375720745e389035ed4b2ac57529e7f34b91e4eb46f13f69a2"));
		assert(genesis.hashMerkleRoot == uint256("0x6d820fe42e061a6685cb77adf58650835cc58c8dbb74c84c6c346ef46694c78a"));
	...
	vSeeds.push_back(CDNSSeedData("209.222.10.199", "209.222.10.199"));
        ...
        // XVGDG script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 20);
        // XVGDG private keys start with '9' or 'A'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 22);
        // XVGDG BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // XVGDG BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // XVGDG BIP44 coin type is '477' (0x800001dd)
        ...
        strMasternodePoolDummyAddress = "VkBKL2KJ8BUEzZyGYyFnawsc7B3RvQ66nE";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // XVGDG: 1 day
        nTargetSpacing = 2 * 60;  // XVGDG: 1 minute
        nLastPOWBlock = 400;
        nMaturity = 15;
       ...
       // assert(hashGenesisBlock == uint256("0x0000052fb2d73affa774918873d242506449a3f113a3e815ec5b939b31e1e5d2"));
        ...
        // Testnet XVGDG addresses start with 'n'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 112);
        // Testnet XVGDG script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 10);
        // Testnet private keys start with '5' or 'n' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 240);
        // Testnet XVGDG BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet XVGDG BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet XVGDG BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // XVGDG: 1 day
        nTargetSpacing = 2 * 60;        // XVGDG: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
