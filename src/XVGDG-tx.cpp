...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("XVGDG Core VergeDarkGreen-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  XVGDG-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded XVGDG transaction") + "\n" +
                               "  XVGDG-tx [options] -create [commands]   " + _("Create hex-encoded XVGDG transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded XVGDG transaction
