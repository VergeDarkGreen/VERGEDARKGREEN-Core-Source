...
// Copyright (c) 2015-2017 The XVGDG Core developers
// Copyright (c) 2019 The XVGDG Core developers
 ...
 * XVGDG system. There are three: the main network on which people trade goods
