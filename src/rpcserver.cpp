...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XVGDG features */
        {"XVGDG", "masternode", &masternode, true, true, false},
        {"XVGDG", "listmasternodes", &listmasternodes, true, true, false},
        {"XVGDG", "getmasternodecount", &getmasternodecount, true, true, false},
        {"XVGDG", "masternodeconnect", &masternodeconnect, true, true, false},
        {"XVGDG", "masternodecurrent", &masternodecurrent, true, true, false},
        {"XVGDG", "masternodedebug", &masternodedebug, true, true, false},
        {"XVGDG", "startmasternode", &startmasternode, true, true, false},
        {"XVGDG", "createmasternodekey", &createmasternodekey, true, true, false},
        {"XVGDG", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"XVGDG", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"XVGDG", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"XVGDG", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"XVGDG", "getmasternodescores", &getmasternodescores, true, true, false},
        {"XVGDG", "mnbudget", &mnbudget, true, true, false},
        {"XVGDG", "preparebudget", &preparebudget, true, true, false},
        {"XVGDG", "submitbudget", &submitbudget, true, true, false},
        {"XVGDG", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"XVGDG", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"XVGDG", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"XVGDG", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"XVGDG", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"XVGDG", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"XVGDG", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"XVGDG", "checkbudgets", &checkbudgets, true, true, false},
        {"XVGDG", "mnsync", &mnsync, true, true, false},
        {"XVGDG", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> XVGDG-cli " + methodname + " " + args + "\n";
}
