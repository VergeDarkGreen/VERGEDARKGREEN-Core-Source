Contributing to XVGDG Core
==================================

The XVGDG Core project operates an open contributor model where anyone is
...
The following applies to code changes to the XVGDG Core project, and is not to be
confused with overall XVGDG Network Protocol consensus changes.

Whether a pull request is merged into XVGDG Core rests with the project merge
...
Patches that change XVGDG consensus rules are considerably more involved than
...
Where a patch set proposes to change the XVGDG consensus, it must have been
...
The project leader is the release manager for each XVGDG Core release.
