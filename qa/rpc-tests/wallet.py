...
#   c) node1 mines 32 blocks, so now node 0 has 500000XVGDG, node 1 has 4250XVGDG, node2 has none.
#   d) node0 sends 601 XVGDG to node2, in two transactions (301 XVGDG, then 300 XVGDG).
